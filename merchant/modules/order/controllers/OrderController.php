...
class OrderController extends BaseController
{
    ...
    public function actionExport()
    {
        ...
        $order = Order::find()
            ->select('id,order_sn,buyer_id,pick_id,pick_name,pick_mobile,message,created_at,shipping_status')
        ...
        foreach ( $order as $item ){
            ...
            $list[$item['id']]['shipping_status'] = ShippingStatusEnum::getValue($item['shipping_status']);
